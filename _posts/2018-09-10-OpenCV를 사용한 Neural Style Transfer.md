...
categories: 예술
tags: ["Neural Style Transfer", OpenCV, 이미지처리]
comments: true
---
...
>
> 번역자의 부가설명은 `인용구`를 이용해 구분했습니다.  [원문 링크](https://www.pyimagesearch.com/2018/08/27/neural-style-transfer-with-opencv/)  
...
[//]: # (Image References)
[image0]: {{ site.url }}/images/media/48_0.png
[image1]: {{ site.url }}/images/media/48_1.png
[image2]: {{ site.url }}/images/media/48_2.png
[image3]: {{ site.url }}/images/media/48_3.png
[image4]: {{ site.url }}/images/media/48_4.jpeg
[image5]: {{ site.url }}/images/media/48_5.png
[image6]: {{ site.url }}/images/media/48_6.png
[image7]: {{ site.url }}/images/media/48_7.jpg
[image8]: {{ site.url }}/images/media/48_8.jpg
[image9]: {{ site.url }}/images/media/48_9.jpg
...
<img  src='https://www.pyimagesearch.com/wp-content/uploads/2018/08/neural_style_transfer_example.jpg'>
...
> 
> 그래서 코드와 함께 짧게 설명할까 합니다. [이곳](https://medium.com/tensorflow/neural-style-transfer-creating-art-with-deep-learning-using-tf-keras-and-eager-execution-7d541ac31398) 을 참고하였고, 이를 번역한 `Keras` Tutorial 의 문서 Neural Style Transfer : tf.keras와 eager execution를 이용한 딥러닝 미술 작품 만들기(Neural Style Transfer: Creating Art with Deep Learning using tf.keras and eager execution) 를 참고하시면 좋을 것 같습니다. 또한 code 는 Team-Keras 의 코드를 가져왔습니다. 그것은 [여기](https://github.com/keras-team/keras/blob/master/examples/neural_style_transfer.py)를 참고해주세요.  
>
...
>  ![Lcontent](http://latex.codecogs.com/gif.latex?L_%7Bcontent%7D%3D%5Cfrac%7B1%7D%7B2%7D%5Csum_%7Bij%7D%28F_%7Bij%7D%5El%20-%20P_%7Bij%7D%5El%29%5E2)
> 
>```python
...
**스타일 이미지**  
![image7]{: width="400" height="400"}{: center}  

![image8]{: width="400" height="400"}{: center}  

![image9]{: width="400" height="400"}{: center}   

**콘텐트 이미지**  
![image0]{: width="400" height="400"}{: center}  

**결과 이미지 : spiderman with wave**  
![image1]{: width="400" height="400"}{: center}   

**결과 이미지 : spiderman with starry night**  
![image2]{: width="400" height="400"}{: center}  

**결과 이미지 : spiderman with composition_vii**  
![image3]{: width="400" height="400"}{: center}   


스파이더맨의 수트의 선 뿐만 아니라 배경의 모양 윤곽도 잘 살렸습니다. 그래서 제 Github 프로필 사진으로도 시도해 보았습니다.


**콘텐트 이미지 : my pic of inside the lift**  
![image4]{: width="400" height="400"}{: center}    


**결과 이미지 : my pic with starry night**  
![image5]{: width="400" height="400"}{: center} 
 
**결과 이미지 : my pic with composition_vii**  
![image6]{: width="400" height="400"}{: center} 
