...
> 이 문서에서는 Generative Adversarial Networks(GANs)의 개념을 설명하고, `MNIST Data`, `Keras`, `Tensorflow`를 이용해 간단한 GANs 모델을 만들어 볼 것입니다. 원문 튜토리얼에 대한 번역자의 부가설명은 `인용구`를 이용해 표현합니다. [원문링크](https://www.datacamp.com/community/tutorials/generative-adversarial-networks)   
...
[//]: # (Image References)
[image0]: {{ site.url }}/images/media/89_0.png
[image1]: {{ site.url }}/images/media/89_1.png
[image2]: {{ site.url }}/images/media/89_2.png
[image3]: {{ site.url }}/images/media/89_3.png
[image4]: {{ site.url }}/images/media/89_4.png
[image5]: {{ site.url }}/images/media/89_5.png
[image6]: {{ site.url }}/images/media/89_6.png
